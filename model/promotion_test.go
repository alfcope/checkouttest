...
var testCases = []struct {
	...
	{ //Edge case: basket without items
		[]*Item{},
		NewFreeItemsPromotion(map[ProductCode][]FreeItemsPromoConditions{"P1": {{Buy: 2, Free: 1}}}),
		0,
		0,
		0,
	}, { //Different products
		...
		NewFreeItemsPromotion(map[ProductCode][]FreeItemsPromoConditions{"P2": {{Buy: 2, Free: 1}}}),
		0,
		2,
		1,
	}, {
		...
		NewFreeItemsPromotion(map[ProductCode][]FreeItemsPromoConditions{"P1": {{Buy: 5, Free: 2}, {Buy: 2, Free: 1}}}),
		0,
		7,
		3,
	},
